...
if lapack_info:
    config.add_extension(name='gp.linalg_utils',sources=['javelin/gp/linalg_utils.f','javelin/blas_wrap.f'])
    config.add_extension(name='gp.incomplete_chol',sources=['javelin/gp/incomplete_chol.f'])
...
config.add_extension(name='gp.cov_funs.distances',sources=['javelin/gp/cov_funs/distances.f'])

config.add_extension(name='spear_covfunc',sources=['javelin/spear_covfunc.f90'])
